...
class DialogueRecoveryStatus(StrEnum):
    ...
    DELETE_FINALIZED_AFTER_STORAGE = "DELETE_FINALIZED_AFTER_STORAGE"
    DELETE_UNKNOWN_CONTAINED = "DELETE_UNKNOWN_CONTAINED"
    DELETE_UNKNOWN_CONTAINMENT_PENDING = "DELETE_UNKNOWN_CONTAINMENT_PENDING"
