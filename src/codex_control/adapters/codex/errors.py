...
class CodexAdapterErrorCategory(str, Enum):
    ...
    THREAD_REQUEST_INVALID="thread_request_invalid"; THREAD_PRECONDITION_CHANGED="thread_precondition_changed"; THREAD_OPERATION_BUSY="thread_operation_busy"; THREAD_START_REJECTED="thread_start_rejected"; THREAD_START_UNKNOWN="thread_start_unknown"; THREAD_RESUME_REJECTED="thread_resume_rejected"; THREAD_RESUME_UNKNOWN="thread_resume_unknown"; THREAD_DELETE_UNKNOWN="thread_delete_unknown"
    TURN_REQUEST_INVALID="turn_request_invalid"; TURN_PRECONDITION_CHANGED="turn_precondition_changed"; TURN_OPERATION_BUSY="turn_operation_busy"; TURN_START_REJECTED="turn_start_rejected"; TURN_START_UNKNOWN="turn_start_unknown"; TURN_STREAM_UNKNOWN="turn_stream_unknown"; TURN_TERMINAL_FAILED="turn_terminal_failed"; TURN_INTERRUPT_NOT_ACTIVE="turn_interrupt_not_active"; TURN_INTERRUPT_BUSY="turn_interrupt_busy"; TURN_INTERRUPT_REJECTED="turn_interrupt_rejected"; TURN_INTERRUPT_UNKNOWN="turn_interrupt_unknown"
